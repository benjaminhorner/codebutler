...
module.exports = (grunt)->
            ...
            dev:
                ...
                files:
                    '<%= pkg.devPath %>assets/js/app.js': [
                        ...
                        '<%= pkg.path %>coffee/**/RefreshView.coffee',
                        '<%= pkg.path %>coffee/**/LoadMore.coffee',
                        '<%= pkg.path %>coffee/**/UIView.coffee',
            ...
            dev:
                options:
                    banner:   '/*!\n' +
                              ...
                              ' */\n'
                files:
                    '<%= pkg.devPath %>assets/js/libs.min.js': ['<%= pkg.path %>coffee/libs/modernizr.js','<%= pkg.path %>coffee/libs/*.js']
            ...
            prod:
                options:
                    banner:   '/*!\n' +
                              ...
                              ' */\n'
                files:
                    '<%= pkg.prodPath %>assets/js/libs.min.js': ['<%= pkg.path %>coffee/libs/modernizr.js','<%= pkg.path %>coffee/libs/*.js']

        minjson:
            dev:
                files:
                    '<%= pkg.devPath %>data.json': ['<%= pkg.path %>*.json']
            prod:
                files:
                    '<%= pkg.prodPath %>data.json': ['<%= pkg.path %>*.json']
    ...
    grunt.registerTask('default', ['coffee:dev', 'uglify:dev', 'minjson:dev', 'compass:dev', 'htmlmin:dev', 'imagemin:dev', 'copy:dev', 'replace:dev', 'watch'])
    grunt.registerTask('compile', ['coffee:dev', 'uglify:dev', 'minjson:dev', 'compass:dev', 'htmlmin:dev', 'imagemin:dev', 'replace:dev'])
    grunt.registerTask('build', ['clean:prod', 'coffee:prod', 'uglify:prod', 'minjson:prod', 'compass:prod', 'imagemin:prod', 'copy:prod', 'htmlmin:prod', 'replace:prod', 'cssmin:prod'])
